...
import { SiFlutter, SiPhp, SiLaravel } from "react-icons/si";
import { FaJava, FaPython, FaReact, FaUnity, FaFigma, FaGitAlt } from "react-icons/fa";
import { RiNextjsFill, RiVercelFill } from "react-icons/ri";

export const assets = {
  user_image, code_icon, code_icon_dark, edu_icon, edu_icon_dark,
  project_icon, project_icon_dark, vscode, firebase, figma, git,
  right_arrow_white, logo, logo_dark, mail_icon, mail_icon_dark,
  profile_img, download_icon, hand_icon, header_bg_color,
  moon_icon, sun_icon, arrow_icon, arrow_icon_dark,
  menu_black, menu_white, close_black, close_white,
  web_icon, mobile_icon, ui_icon, graphics_icon,
  right_arrow, send_icon, right_arrow_bold, right_arrow_bold_dark,
  game_img, app_img, hotel_img, ai_img,
};
...
export const skillsData = [
  ...
  // ── Programming — لغات البرمجة الأساسية ──────────────────
  { name: "Java",       category: "Programming", IconComponent: FaJava,           color: "#5382a1" },
  { name: "Python",     category: "Programming", IconComponent: FaPython,         color: "#3776ab" },
  { name: "JavaScript", category: "Programming", IconComponent: IoLogoJavascript, color: "#f7df1e" },
  { name: "MySQL",      category: "Programming", IconComponent: GrMysql,          color: "#00758f" },

  // ── Web — تقنيات الويب فقط ───────────────────────────────
  { name: "HTML",       category: "Web",         IconComponent: IoLogoHtml5,      color: "#e34f26" },
  { name: "CSS",        category: "Web",         IconComponent: IoLogoCss3,       color: "#1572b6" },
  { name: "PHP",        category: "Web",         IconComponent: SiPhp,            color: "#777bb4" },
  { name: "Next",       category: "Web",         IconComponent: RiNextjsFill,     color: "#000000" },
  { name: "Laravel",    category: "Web",         IconComponent: SiLaravel,        color: "#ff2d20" },

  // ── Mobile — تطوير الجوال ────────────────────────────────
  { name: "React Native", category: "Mobile",    IconComponent: FaReact,          color: "#61dafb" },
  { name: "Flutter",      category: "Mobile",    IconComponent: SiFlutter,        color: "#54c5f8" },

  // ── Tools — الأدوات ──────────────────────────────────────
  { name: "Git",     category: "Tools", IconComponent: FaGitAlt,      color: "#f1502f" },
  { name: "Figma",   category: "Tools", IconComponent: FaFigma,       color: "#F24E1E" },
  { name: "Unity",   category: "Tools", IconComponent: FaUnity,       color: "#333333" },
  { name: "Vercel",  category: "Tools", IconComponent: RiVercelFill,  color: "#000000" },
...
export const projectsData = [
  {
    ...
    details: "This game, built specifically to sharpen children's cognitive abilities, provides an entertaining and highly effective platform for memory skill development. Developed using the robust Unity engine and C#, it features a dynamic difficulty system with multiple tiers (Easy, Medium, Hard) that intelligently adapt to the player. To ensure maximum replayability and engagement, the cards are algorithmically randomized with every session. I personally drove the end-to-end development process, overseeing all core game logic, intuitive UI/UX design, and seamless integration of sound effects and animations to deliver a polished and superior user experience.",
